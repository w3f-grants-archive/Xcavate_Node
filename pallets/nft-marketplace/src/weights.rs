...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// Proof: `NftMarketplace::ListedNfts` (`max_values`: Some(1), `max_size`: Some(8000004), added: 8000499, mode: `MaxEncodedLen`)
	/// Storage: `NftMarketplace::SellerListings` (r:1 w:1)
	/// Proof: `NftMarketplace::SellerListings` (`max_values`: None, `max_size`: Some(89000044), added: 89002519, mode: `MaxEncodedLen`)
	...
	fn list_object() -> Weight {
		...
		//  Measured:  `79`
		//  Estimated: `89003509`
		// Minimum execution time: 8_575_885_000 picoseconds.
		Weight::from_parts(8_752_695_000, 0)
			.saturating_add(Weight::from_parts(0, 89003509))
	...
	/// Proof: `NftMarketplace::SellerSoldNfts` (`max_values`: None, `max_size`: Some(89000044), added: 89002519, mode: `MaxEncodedLen`)
	...
	fn buy_nft() -> Weight {
		...
		//  Measured:  `44657`
		//  Estimated: `89003509`
		// Minimum execution time: 10_919_828_000 picoseconds.
		Weight::from_parts(11_757_414_000, 0)
			.saturating_add(Weight::from_parts(0, 89003509))
