...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// Proof: `PropertyGovernance::OngoingVotes` (`max_values`: None, `max_size`: Some(22), added: 2497, mode: `MaxEncodedLen`)
	...
	fn propose() -> Weight {
		...
		Weight::from_parts(33_715_000, 0)
	...
	/// Proof: `PropertyGovernance::OngoingInqueryVotes` (`max_values`: None, `max_size`: Some(22), added: 2497, mode: `MaxEncodedLen`)
	fn inquery_against_letting_agent() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `433`
		//  Estimated: `6687`
	...
	fn vote_on_proposal() -> Weight {
		...
		Weight::from_parts(41_454_000, 0)
			.saturating_add(Weight::from_parts(0, 6687))
