...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// Proof: `CommunityProject::ListedNftTypes` (`max_values`: None, `max_size`: Some(40039), added: 42514, mode: `MaxEncodedLen`)
	...
	/// Proof: `CommunityProject::TokenBonder` (`max_values`: None, `max_size`: Some(320022), added: 322497, mode: `MaxEncodedLen`)
	...
	/// Proof: `CommunityProject::VotedUser` (`max_values`: None, `max_size`: Some(320022), added: 322497, mode: `MaxEncodedLen`)
